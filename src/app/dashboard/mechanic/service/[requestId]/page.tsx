      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            <Input value={String(partsPrice)} onChange={(e) => setPartsPrice(Number(e.target.value) || 0)} type="number" min={0} step="0.01" placeholder="Parts price" />
            <Input value={String(laborPrice)} onChange={(e) => setLaborPrice(Number(e.target.value) || 0)} type="number" min={0} step="0.01" placeholder="Labor price" />
            <Input value={String(totalPrice)} onChange={(e) => setTotalPrice(Number(e.target.value) || 0)} type="number" min={0} step="0.01" placeholder="Total price" />
          </div>
          ...
          {maintenanceType === "oil_change" && (
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              ...
              <select value={oilFilterChanged} onChange={(e) => setOilFilterChanged(e.target.value)} className="h-10 rounded-md border border-border bg-background px-3 text-sm text-foreground outline-none ring-primary/10 transition focus:border-primary focus:ring-2">
          ...
          {maintenanceType === "timing_service" && (
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              ...
              <select value={waterPumpChanged} onChange={(e) => setWaterPumpChanged(e.target.value)} className="h-10 rounded-md border border-border bg-background px-3 text-sm text-foreground outline-none ring-primary/10 transition focus:border-primary focus:ring-2">
          ...
          {maintenanceType === "brake_service" && (
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              <select value={brakeAxle} onChange={(e) => setBrakeAxle(e.target.value)} className="h-10 rounded-md border border-border bg-background px-3 text-sm text-foreground outline-none ring-primary/10 transition focus:border-primary focus:ring-2">
              ...
              <select value={brakeFluidChanged} onChange={(e) => setBrakeFluidChanged(e.target.value)} className="h-10 rounded-md border border-border bg-background px-3 text-sm text-foreground outline-none ring-primary/10 transition focus:border-primary focus:ring-2">
          ...
          {maintenanceType === "inspection" && (
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <select value={inspectionResult} onChange={(e) => setInspectionResult(e.target.value)} className="h-10 rounded-md border border-border bg-background px-3 text-sm text-foreground outline-none ring-primary/10 transition focus:border-primary focus:ring-2">
